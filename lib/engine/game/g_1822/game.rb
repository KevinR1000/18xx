    ...
    module G1822
      class Game < Game::Base
        ...
        MARKET = [
          ...
          %w[60 70 80 90 100b 110 120 135 150 165 180 200 220 245 270 300 330 360 400 450 500],
          %w[50 60 70 80 90b 100 110 120 135 150 165 180 200 220 245 270 300 330],
          %w[45y 50 60 70 80b 90 100 110 120 135 150 165 180 200 220 245],
          %w[40y 45y 50 60 70b 80 90 100 110 120 135 150 165 180],
          %w[35y 40y 45y 50 60b 70 80 90 100 110 120 135],
        ...
        STOCKMARKET_COLORS = Base::STOCKMARKET_COLORS.merge(both_par: :peach).freeze
        MARKET_TEXT = Base::MARKET_TEXT.merge(both_par: 'Par value for Major or Minor',
                                              par: 'Par value for Minor').freeze
